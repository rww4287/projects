	...
	$().ready(function(){
		$("#signUpBtn").click(function(){
			if($("#userEmail").val() == null || $("#userEmail").val() == ""){
				...
				$("#userPassword").val() != null && $("#userPassword").val() != "" ) {
				
				$("#loginForm").attr({
					"action" : "<c:url value="/movie/user/login"/>",
					"method" : "post"
				});
			}
...
<body>
	...
	<form:form id="loginForm" style="margin-left: 20px; margin-top: 20px;">
...
<!-- 		<div class="input-group input-group-sm">
		...
		<button type="submit" id="signUpBtn" class="btn btn-default btn-sm" style ="margin-top: 20px;" >
		  <span class="glyphicon glyphicon-ok" aria-hidden="true"></span>로그인 
		</button>
